...
%\centering
%\def\svgwidth{350pt}
%\input{assets/binary_tree_linthicum.pdf_tex}
%\caption{Einfacher Entscheidungsbaum mit einem Merkmal und der Tiefe 2}
%\label{fig:binary}
%\end{figure}
...
Ein Entscheidungsbaum ist ein Modell aus dem Bereich des maschinellem Lernens, welches wiederum ein Teilgebiet von künstlicher Intelligenz ist. Obwohl Entscheidungsbäume derzeit als äußerst mächtige Lernalgorithmen angesehen werden, sind ihre Prognosen äußerst leicht nachzuvollziehen. Im Grunde genommen ist ein Entscheidungsbaum eine Verkettung von \textit{Wenn-Sonst-Anweisungen}, die schlussendlich zum Ergebnis führen. \autoref{fig:binary_tree_linthicum} zeigt den Entscheidungsbaum für die Solaranlage in Linthicum, Maryland, welcher vom \textit{CART-Algorithmus} erstellt.
...
Zudem müssen relativ wenige Merkmale in den Lernalgorithmus einfließen, da für jede einzelne Solaranlage ein eigenes Modell erstellt werden soll. Die Anzahl der zu berücksichtigenden Merkmale zu beschränken ist vor allem dann sinnvoll, wenn für die Modellerstellung viele verschiedene Merkmale verwendet werden. 
