...
\resizebox{\textwidth}{!}{
\begin{tabular}{| p{1.5cm} | p{1.5cm} | p{2cm} | p{2.2cm} | p{2cm} | p{1.6cm} | p{1.75cm} | p{2cm} |}
\hline
\ac{pv}-Anlagen ID & Größe \newline Daten- satz\tablefootnote{Die Größe des Datensatzes betitelt die Anzahl an Datenreihen, die für das Trainieren des Modells verwendet wurden.} & Maximal- betrag Stromerzeugung in $kW$ & Tiefe des \newline Entschei- \newline dungsbaum & Maximal-\newline anzahl Blätter & Mindest- anzahl Proben Blätter & R²-Wert\tablefootnote{Die Bezeichnungen R²-Wert und der Determinierungskoeffizient lassen sich als Synonyme auffassen.} \newline (Testen) & R²-Wert \newline (Trainieren) \\ \hline
...
1201 &  		 & 		 &   &		&    &      &      \\ \hline
1220 &  293:293  &  6816 & 5 &   48 & 20 & 0.64 & 0.68 \\ \hline
1231 & 1055:1055 &  2660 & 8 &   48 &  7 & 0.74 & 0.86 \\ \hline
1244 & 	790:346  &  2691 & 6 & 3540 &  7 & 0.67 & 0.78 \\ \hline % no solarradiation data
...
Unumstritten ist die Sonneneinstrahlung das wichtigste Merkmal für das Prognosemodell, um eine akkurate Aussage über die zu erwartende Solarstromproduktion zu treffen. Die Bedeutung von diesem Wetterfaktor wurde bereits in \fullref{subsubsec:decisiontree_structure} erläutert und ist durch das \autoref{fig:histogram_feature_quantity} klar ersichtlich. Ebenso wurde bereits des häufigeren erwähnt, dass die Wetterfaktoren sich gegenseitig untereinander beeinflussen. Dass diese Multikollinearität zwischen den verschieden Merkmalen auch von Nutzen sein kann, wird durch die beiden \ac{pv}-Anlagen mit der Indenfikationsnummer $1244$ und $1257$ bewiesen. Die Datenbank von \ac{nrel} umfasst für die beiden \ac{pv}-Anlagen Messwerte für das Jahr 2014, allerdings sind für diese Zeitspanne und der jeweiligen Position der Anlage keine Werte über die Sonneneinstrahlung festgehalten. Die \ac{api} von \textit{wwww.visualcrossing.com} liefert für die beiden Orte Nullwerte für die Sonneneinstrahlung. Der \ac{cart}-Algorithmus erkennt, dass dadurch keine Aufteilung der Datenreihen möglich ist und ignoriert die Sonneneinstrahlung für die Erstellung des Entscheidungsbaum. Folglich wird das Merkmal bei keiner einzigen \textit{Wenn-Sonst-Anweisung} verwendet. Dennoch erzielen die beiden Prognosemodelle einen Determinierungskoeffizienten von bis zu $0.67$. \autoref{fig:predictions_1244} zeigt, dass die Abweichungen vor allem durch viele, kleinere entstehen, wodurch die kumulierten Abweichungen die Aussagekraft des Modells schlechter darstellen als sie eigentlich sind.
