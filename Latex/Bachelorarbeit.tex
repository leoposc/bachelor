...
\begin{center}
\resizebox{\textwidth}{!}{
\begin{tabular}{| p{1.5cm} | p{1.5cm} | p{1.5cm} | p{2cm} | p{1.5cm} | p{2cm} | p{1.5cm} | p{1.7cm} |}
\hline
PV-Anlagen ID & Fläche in $m²$ & Nenn- leistung in $kW$ & Ausrichtung in Grad & Neigung in Grad & Höhen- meter ü. NN & Montierung \\ \hline
10 & 12,06 & 1,12 & 180 & 40,0 & 1792,8 & Fixiert \\ \hline
\end{tabular}}
\end{center}
