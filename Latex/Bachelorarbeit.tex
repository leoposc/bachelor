...
\acro{dwd}[DWD]{Deutsche Wetterdienst}
\acro{eeg}[EEG]{Erneuerbare-Energien-Gesetz}
\acro{fise}[Fraunhofer ISE]{Fraunhofer Institut für Solare Energiesysteme}
...
\acro{pvgis}[PVGIS]{Photovoltaic Geographical Information System}
...
\captionsetup{justification=raggedleft,singlelinecheck=false,skip=-10pt,margin={0cm, 2cm}}\caption*{\scriptsize{Quelle: \cite{ws:dwdradiation}}}
\captionsetup{justification=centering,singlelinecheck=false,skip=25pt,margin={0cm, 0cm}}
