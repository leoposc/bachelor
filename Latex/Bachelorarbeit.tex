...
\subsubsection{Korrelationen abhängig von den Gegebenheiten der Photovoltaikanlage}
...
Die Implementierung des Entscheidungsbaum aus der \textit{scikit-learn Bibliothek} ermöglicht es, Fließkommazahl als Wert für den Parameter \textit{Mindestanzahl an Proben pro Blatt} zu übergeben. \autoref{eqn:min_samples_leaf} 
