...
\resizebox{\textwidth}{!}{
\begin{tabular}{| l | p{3.5cm} | p{3cm} | p{2.5cm} | p{2cm} | p{3cm} | p{1.75cm} | p{2cm} |}
\hline
PV-Anlage ID & Größe Datensatz\tablefootnote{Die Größe des Datensatzes betitelt die Anzahl an Datenreihen, die für das Trainieren des Modells verwendet wurden.} & Maximalbetrag Stromerzeugung & Tiefe des \newline Entscheidungs-\newline baum & Maximal-\newline anzahl Blätter & Mindestanzahl Proben Blätter & R²-Wert\tablefootnote{Die Bezeichnungen R²-Wert und der Determinierungskoeffizient lassen sich als Synonyme auffassen.} \newline (Testen) & R²-Wert \newline (Trainieren) \\ \hline
1199 &  269 & XXXXX & 5 &   48 & 10 & 0.89 & 0.93 \\ \hline
1200 & 1750 & 46015 & 8 &   48 & 10 & 0.89 & 0.90 \\ \hline
1220 &  293 &  6816 & 5 &   48 & 20 & 0.64 & 0.68 \\ \hline
1231 & 1055 &  2660 & 8 &   48 &  7 & 0.74 & 0.86 \\ \hline
...
Unter dem Begriff \textit{Residuen} betitelt man in der Regressionsanalyse die Abweichungen zwischen den prognostizierten und den tatsächlich aufgezeichneten Werten. \autoref{fig:residuals} stellt die Residuen der Solaranlage in Linthicum, Maryland dar. Anhand des Diagramms lassen sich Auffälligkeiten in Bezug auf die Abweichungen erkennen, wodurch sich Fehler innerhalb unseres Modells aufspüren lassen. Schließlich deuten Muster in den Fehlern darauf hin, dass sich noch Informationen in den Datensätzen befinden. Informationen, die bisher noch nicht für die Vorhersage von Werten verwendet wurde. Lediglich eine zufällige Fehlerverteilung deutet darauf, dass die Fehlabweichung keine Besonderheit sind und wir alle zu uns zur Verfügung stehenden Daten für die Prognose der \textit{Stromproduktion} einer PV-Anlage verwendet.
