...
\subsection{Untersuchte Photovoltaikanlagen}

\begin{table}[h]
\begin{center}
%\resizebox{\textwidth}{!}{
\begin{tabular}{| p{1.5cm} | p{1.5cm} | p{1.5cm} | p{2.3cm}  | p{2cm} | p{1.7cm} |}
\hline
PV-Anlagen ID & Fläche in $m²$ & Nenn- leistung in $kW$ & Ausrichtung in Grad & Höhen- meter ü. NN & Montierung \\ \hline
    10 &    12,06 & 1,12 & 180 & 1792,8 & Fixiert \\ \hline
1199 &  366,54 & 52,92 & 180 & 325,0 & Fixiert \\ \hline
1200 & 
\end{tabular}
\end{center}
